...
class FileTracker {
    ...
    async trackFolder(folderPath) {
        let filePaths = await file_1.walkDirectoryToMatchFiles(folderPath, this.includeFileMatcher, this.excludeMatcher, this.ignoreFilesBy);
