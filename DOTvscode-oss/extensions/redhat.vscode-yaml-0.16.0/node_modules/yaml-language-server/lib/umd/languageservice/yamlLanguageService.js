...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./services/yamlSchemaService", "./services/documentSymbols", "./services/yamlCompletion", "./services/yamlHover", "./services/yamlValidation", "./services/yamlFormatter", "./services/yamlLinks", "./services/yamlFolding", "./services/yamlCodeActions", "../languageserver/commandExecutor", "./services/yamlOnTypeFormatting"], factory);
    }
    ...
    function getLanguageService(schemaRequestService, workspaceContext, connection, clientCapabilities) {
        const schemaService = new yamlSchemaService_1.YAMLSchemaService(schemaRequestService, workspaceContext);
        const completer = new yamlCompletion_1.YAMLCompletion(schemaService, clientCapabilities);
        ...
        const yamlCodeActions = new yamlCodeActions_1.YamlCodeActions(commandExecutor_1.commandExecutor, connection, clientCapabilities);
        return {
            configure: (settings) => {
