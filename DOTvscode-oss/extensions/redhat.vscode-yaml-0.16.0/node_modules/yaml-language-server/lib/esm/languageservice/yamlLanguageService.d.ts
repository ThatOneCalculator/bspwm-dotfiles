...
import { Position, CompletionList, Diagnostic, Hover, SymbolInformation, DocumentSymbol, TextEdit, DocumentLink } from 'vscode-languageserver-types';
import { JSONSchema } from './jsonSchema';
import { JSONDocument, DefinitionLink, TextDocument } from 'vscode-json-languageservice';
import { FoldingRange, ClientCapabilities, CodeActionParams, CodeAction, Connection, DocumentOnTypeFormattingParams } from 'vscode-languageserver/node';
...
export declare function getLanguageService(schemaRequestService: SchemaRequestService, workspaceContext: WorkspaceContextService, connection: Connection, clientCapabilities?: ClientCapabilities): LanguageService;
