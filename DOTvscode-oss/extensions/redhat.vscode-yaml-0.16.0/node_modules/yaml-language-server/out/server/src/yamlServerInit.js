...
class YAMLServerInit {
    ...
    connectionInitialized(params) {
        ...
        this.languageService = yamlLanguageService_1.getLanguageService(this.schemaRequestService, this.workspaceContext, this.connection, params.capabilities);
    ...
    registerHandlers() {
        ...
        const settingsHandler = new settingsHandlers_1.SettingsHandler(this.connection, this.languageService, this.yamlSettings, this.validationHandler);
