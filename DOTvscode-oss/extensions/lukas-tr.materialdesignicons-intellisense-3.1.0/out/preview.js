...
exports.showPreview = (node, context) => {
    ...
    if (currentPreviewPanel) {
        ...
        currentPreviewPanel = vscode.window.createWebviewPanel("mdiIconPreview", `${node.doc.name} - Material Design Icon Preview`, columnToShowIn, { enableScripts: false });
