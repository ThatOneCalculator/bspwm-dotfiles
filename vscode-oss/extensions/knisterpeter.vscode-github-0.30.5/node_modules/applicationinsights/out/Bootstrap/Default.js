...
function setupAndStart(setupString) {
    ...
    if (!_extensionEnabled) {
        _statusLogger.logStatus(__assign({}, defaultStatus, { AgentInitializedSuccessfully: false, Reason: "Extension is not enabled. env." + ENV_extensionVersion + "=" + process.env[ENV_extensionVersion] }));
        return null;
    }
