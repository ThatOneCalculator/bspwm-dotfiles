...
exports.BrowseCurrentFile = exports.BrowseOpenIssues = exports.BrowseProject = void 0;
    ...
    runWithToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vscode.workspace.workspaceFolders && editor) {
                ...
                const uri = vscode.Uri.parse(yield this.workflowManager.getGithubFileUrl(folder.uri, file, startLine, endLine));
