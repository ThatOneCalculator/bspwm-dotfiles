...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "request-light", "vscode-languageserver", "../../languageservice/utils/paths", "../../languageservice/utils/schemaUrls"], factory);
    }
    ...
    class SettingsHandler {
         ...
         */
        configurationChangeHandler(change) {
            var _a;
            ...
            for (const uri in this.yamlSettings.yamlConfigurationSettings) {
                ...
                const schemaObj = {
                    ...
                    uri: schemaUrls_1.checkSchemaURI(this.yamlSettings.workspaceFolders, this.yamlSettings.workspaceRoot, uri),
                };
        ...
        setSchemaStoreSettingsIfNotSet() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.yamlSettings.schemaStoreEnabled && !schemaStoreIsSet) {
                    try {
                        const schemaStore = yield this.getSchemaStoreMatchingSchemas();
         ...
         */
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        configureSchemas(uri, fileMatch, schema, languageSettings) {
            uri = schemaUrls_1.checkSchemaURI(this.yamlSettings.workspaceFolders, this.yamlSettings.workspaceRoot, uri);
            if (schema === null) {
