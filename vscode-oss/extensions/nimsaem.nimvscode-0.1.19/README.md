...
- Nim check result reported in `Nim` output channel (great for macro development) <details><summary>demo</summary>![output channel demo](https://github.com/saem/vscode-nim/raw/master/images/nim_vscode_output_demo.gif "Demo of macro evaluation in the output channel")</details>
...
![Debugger preview screenshot](https://github.com/saem/vscode-nim/raw/master/images/debugging-screenshot.png)
---
## Code Completion
